...
<table class="table mt-4">
    ...
    ?>
        <tr>
            ...
            <td>
                <a href="home.php?id=<?php echo $row['id']?>&halaman=delete"><button type="submit" class="btn btn-primary">Delete</button></a>
                <a href="home.php?id=<?php echo $row['id']?>&halaman=edit"><button type="submit" class="btn btn-danger">Edit</button></a>
